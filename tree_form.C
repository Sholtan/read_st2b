...
void tree_form(TString inBinFileName = "st2b/taiga607_st2b_0", TString outFilePath = "tree_form_out/gamma_0")
{
  if (inBinFileName == "") {
  ...
  TFile* file = new TFile(outFilePath+".root", "RECREATE");
  /* Binary file header */
  int32_t N_run;
  ...
  while (!fin.eof()) {
    ...
    cout << sizeof(int32_t) << ",   N_run: " << N_run << endl;

    fin.read((char*)&i_scattering, sizeof(int32_t));
    cout << sizeof(int32_t) << ",   i_scattering: " << i_scattering << endl;

    fin.read((char*)&i_tel, sizeof(int32_t));
    cout << sizeof(int32_t) << ",   i_tel: " << i_tel << endl;

    fin.read((char*)&N_b_f, sizeof(int32_t));
    cout << sizeof(int32_t) << ",   N_b_f: " << N_b_f << endl;

    fin.read((char*)&E, sizeof(double));
    cout << sizeof(double) << ",   E: " << E << endl;

    fin.read((char*)&theta, sizeof(double));
    cout << sizeof(double) << ",   theta: " << theta << endl;

    fin.read((char*)&phi, sizeof(double));
    cout << sizeof(double) << ",   phi: " << phi << endl;

    fin.read((char*)X_core, sizeof(X_core));
    cout << sizeof(X_core) << ",   X_core: " << X_core[0] << " " << X_core[1] << " " << X_core[2] << endl;

    fin.read((char*)&h1int, sizeof(double));
    cout << sizeof(double) << ",   h1int: " << h1int << endl;

    fin.read((char*)&Particle_type, sizeof(double));
    cout << sizeof(double) << ",   Particle_type: " << Particle_type << endl;

    fin.read((char*)&xmax, sizeof(double));
    cout << sizeof(double) << ",   xmax: " << xmax << endl;

    fin.read((char*)&hmax, sizeof(double));
    cout << sizeof(double) << ",   hmax: " << hmax << endl;

    fin.read((char*)X_telescope, sizeof(X_telescope));
    cout << sizeof(X_telescope) << ",   X_telescope: " << X_telescope[0] << " " << X_telescope[1] << " " << X_telescope[2] << endl;

    fin.read((char*)X_offset, sizeof(X_offset));
    cout << sizeof(X_offset) << ",   X_offset: " << X_offset[0] << " " << X_offset[1] << endl;

    fin.read((char*)&theta_tel, sizeof(double));
    cout << sizeof(double) << ",   theta_tel: " << theta_tel << endl;

    fin.read((char*)&phi_tel, sizeof(double));
    cout << sizeof(double) << ",   phi_tel: " << phi_tel << endl;

    fin.read((char*)&da1, sizeof(double));
    cout << sizeof(double) << ",   da1: " << da1 << endl;

    fin.read((char*)&da0, sizeof(double));
    cout << sizeof(double) << ",   da0: " << da0 << endl;

    fin.read((char*)&T0, sizeof(double));
    cout << sizeof(double) << ",   T0: " << T0 << endl;

    fin.read((char*)&N_pixels, sizeof(int32_t));
    cout << sizeof(int32_t) << ",   N_pixels: " << N_pixels << endl << "waiting for enter";
